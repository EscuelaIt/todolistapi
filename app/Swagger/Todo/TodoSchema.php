 ...
 *         @OA\Property(property="completed", type="boolean", description="Todo completada o no. Las tareas siempre se crean como no completadas. Se ignorará este campo al insertar."),
 *     }
 * )
 */
